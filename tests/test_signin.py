...
# error - the web only shows email error message
# @pytest.mark.skip(reason="error - the web only shows email error message")
...
# @pytest.mark.skip(reason="/index page not found")
...
def test_spam_signin(page: Page):
    signin_page = SigninPage(page)
